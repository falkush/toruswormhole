...
int main()
{
   ...
   //sf::RenderWindow window(sf::VideoMode(1920, 1080, 32), "Torus Wormhole - Press ESC to stop", sf::Style::Titlebar | sf::Style::Close);
	sf::RenderWindow window(sf::VideoMode(1920, 1080, 32), "Torus Wormhole - Press ESC to stop", sf::Style::Fullscreen);
	sf::Texture texture;
    sf::Sprite sprite;
    ...
    while (window.isOpen())
    {
		...
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::C)) { r += 0.003;  alpha = alpha2 * r; beta = beta2 + alpha; }
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::V)) { r -= 0.003;  alpha = alpha2 * r; beta = beta2 + alpha; }
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::B)) { alpha2 += 0.003; alpha = alpha2 * r; beta = beta2 + alpha;}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::N)) { alpha2 -= 0.003;  alpha = alpha2 * r; beta = beta2 + alpha;}
		...
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::G)) {beta2 += 0.03; beta += 0.03;}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::H)) {beta2 -= 0.03; beta -= 0.03;}
        ...
        if (focus)
        {
            ...
            cudathingy(pixels, pos0, pos1, pos2, vec0, vec1, vec2, addy0, addy1, addy2, addz0, addz1, addz2, inside,alpha,beta,bigr,r,other);
